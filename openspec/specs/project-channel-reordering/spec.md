# project-channel-reordering Specification

## Purpose

Project and channel navigation lists SHALL support user-defined display ordering while preserving tmux sessions and window indexes as the underlying source of truth.
