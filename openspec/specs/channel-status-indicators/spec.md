# channel-status-indicators Specification

## Purpose

前端在频道列表(`SessionManagerV2`)与频道标签(`TabBar`)上为每个频道及其所属项目渲染与状态对应的可视标记,使用户一眼可辨哪些频道需要关注,并在进入频道时自动清除粘性提醒标记。所有提示文案均通过 i18n 提供 zh-CN 与 en 两种语言。
